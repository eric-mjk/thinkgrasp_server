...
def get_and_process_data(cropping_box,color, depth):
    ...
    # Intrinsics scaled from the sim camera (l515_camera) 1920x1080 matrix to the
    # 640x480 images sent to ThinkGrasp (x scale 1/3, y scale 4/9).
    # Original: fx=fy=1399.0697520372776, cx=960.0, cy=540.0
    camera = CameraInfo(
        width=640,
        height=480,
        fx=466.35658401242587,
        fy=621.8087786832345,
        cx=320.0,
        cy=240.0,
        scale=1000.0,
    )
